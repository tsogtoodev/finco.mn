...
// Contact CTA for the product listing + detail pages — a copy of HomeContactCta
// (Figma 1:14351): near-black panel, heading + subtext + white pill, floating 3D
// Finco-card graphic on the right. Clicking the card scene opens the feedback
// dialog (Figma 464:10744). Shares the `home.contact.*` copy since the message
// is identical.
const { t } = useI18n()
