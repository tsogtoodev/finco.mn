      ...
      >
        ...
        <div class="hero-tabs absolute inset-x-0 bottom-0 lg:bottom-9">
          ...
          <ul
            ...
            class="mx-auto hidden w-full max-w-[1200px] gap-4 overflow-x-auto px-6 pb-6 lg:flex lg:justify-between lg:gap-0 lg:px-6 xl:px-0 lg:pb-0 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
          >
            <li
              v-for="(s, i) in slides"
              :key="s.key"
